...
try:
    import cupy as cp
    from fastlisaresponse.cutils.pyresponse_gpu import get_response_wrap as get_response_wrap_gpu
    from fastlisaresponse.cutils.pyresponse_gpu import get_tdi_delays_wrap as get_tdi_delays_wrap_gpu
...
from fastlisaresponse.cutils.pyresponse_cpu import get_response_wrap as get_response_wrap_cpu
from fastlisaresponse.cutils.pyresponse_cpu import get_tdi_delays_wrap as get_tdi_delays_wrap_cpu
import time
import h5py
...
class ResponseWrapper:
    ...
    def generate_waveform(self, *args, **kwargs):
        ...
        Return:
            xp.ndarray: The generated waveform.
        """
        # get the waveform
    ...
    def apply_response(self, h, lam, beta):
        """Apply the response model to the waveform

        Args:
            h (xp.ndarray): The generated waveform.
            lam (float): Ecliptic longitude in radians.
            beta (float): Ecliptic latitude in radians.
    ...
    def __call__(self, *args, **kwargs):
        ...
        h = self.generate_waveform(*args, **kwargs)
        return self.apply_response(h, lam, beta)
