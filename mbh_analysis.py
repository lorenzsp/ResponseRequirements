...
if __name__=="__main__":
    ...
    for ind_ref, label in zip([index_arm, index_rot, index_tran],[rf"Armlength $\sigma=${armlength_error} m", rf"Rotation $\sigma=${rotation_error} m",  rf"Translation $\sigma=${translation_error} m"]):
